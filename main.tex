...
\cvitem{
    \cvdurationstyle{November 2019 - February 2021}
}{
    ...
    \item Courses: \textit{``Introduction to Functional Programming''}, \textit{``Functional Programming''} and \textit{``Introduction to Programming with Python''}
    \end{itemize}
}
...
\cvitem{
    ...
    LibreOffice Perugia HackFest 2017, CSE Hackathon 2019 (Göteborgs Universitet), Code With Friends Fall and Summer 2020
}
